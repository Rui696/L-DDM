...
from .utils import deprecate, logging_util, maybe_allow_in_graph
...
class Attention(nn.Module):
    ...
    def set_use_memory_efficient_attention_xformers(
        ...
        if use_memory_efficient_attention_xformers:
            print("'Using memory efficient attention from xformers' is deleted. Please check the website again for original code.")
        else:
            if is_lora:
